...
## Fork
This is a fork of the original `xlnt` repository that replaces the faulty `third-party/libstudxml` submodule such that `git submodule update --init --recursive` works as expected.
